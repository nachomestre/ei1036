...
function MP2_Ejecutar_crearT(){
    MP2_CrearT("MP2_GrupoCliente003");
}
add_action('admin_post_nopriv_my_datos_3', 'MP2_my_datos_3'); //no autentificados
//add_action('admin_post_my_datos_3', "MP2_my_datos_3"); 
