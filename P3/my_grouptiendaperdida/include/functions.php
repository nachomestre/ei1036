...
{//formulario registro amigos de $user_email
	...
	<br/>
	<img id="img_foto" border=3 height=100 width=100>	
	<br/>
		    ...
		    if ($key == "person_id"){
                ...
                foreach ($rows as $row) {
                    ...
                    foreach ($row as $key => $val) {
			            if ($key == "foto_file"){
			                echo '<td><img src="https://tiendaperdida2.000webhostapp.com/wp-content/plugins/fotos/', $val, '" border=3 height=100 width=100></td>';
			            } else {echo "<td>", $val, "</td>";}
                    }
                    print "</tr>";
                }
